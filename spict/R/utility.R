...
#' @name calc.process.resid
#' @title Calculate process residuals
#'
#' @param rep A result report as generated by running \code{fit.spict}.
#' @param dt Time resolution of process residuals. By default (NULL), the
#'     process residuals are calculated corresponding to the time resolution of
#'     the input data.
#'
#' @details Calculates process residuals for biomass and fishing mortality
#'     process.
#'
#' @return Data frame with year, process residuals for biomass and fishing
