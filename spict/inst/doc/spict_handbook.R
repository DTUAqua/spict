...
## ----plotspict.diagnostic.process, results='show', message=FALSE, warning=FALSE, fig.width=5.5, fig.height=7, fig.show='hold'----
...
## ----plotspict.compare, results='show', message=FALSE, warning=FALSE, fig.width=5.5, fig.height=7, fig.show='hold'----
data(pol)
inp <- pol$hake
rep1 <- fit.spict(inp)
...
## ----plotspict.retro, results='show', message=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.show='hold'----
## res <- fit.spict(pol$albacore)
res <- retro(res, nretroyear = 4, mc.cores = 1)
plotspict.retro(res)

## ----mohns_rho, results='show', message=FALSE, warning=FALSE------------------
## res <- fit.spict(pol$albacore)
## res <- retro(res)
mohns_rho(res, what = c("FFmsy", "BBmsy"))

## ----plotspict.retro.fixed, results='show', message=FALSE, warning=FALSE------
## res <- fit.spict(pol$albacore)
## res <- retro(res)
