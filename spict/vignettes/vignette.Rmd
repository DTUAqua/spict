...
A stable development version can be istalled from gihtub using the `devtools` (or `ghit`) package:
```{r, eval=FALSE}
...
A specific verision of `spict` can be installed using the first few digits of the SHA:
