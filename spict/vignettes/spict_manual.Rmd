...
library(spict)
```
The content of this vignette pertains to the version printed above that can be found  [here](`r paste0("https://github.com/DTUAqua/spict/tree/v", packageVersion("spict"))`).
